...
const Gun = () => {
    ...
    const menuItemsOne = [
        ...
        { img: MenuImg1, id: '93', name: 'Травматична зброя' },
        { img: MenuImg2, id: '94', name: 'Пневматична зброя' },
        { img: MenuImg3, id: '95', name: 'Зброя під патрон Флобер' },
        { img: MenuImg4, id: '96', name: 'Сигнально - шумова зброя' },
        { img: MenuImg5, id: '97', name: 'Метальна зброя' }
    ];
    ...
    const categoriesOne = [93, 94, 95, 96, 97];
